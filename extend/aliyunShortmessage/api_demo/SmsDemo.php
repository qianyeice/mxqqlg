<?php
namespace aliyunShortmessage\api_demo;
...
class SmsDemo
{
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$value) {
        ...
        $request->setSignName( config('aliyun')['Sign']);

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode(config('aliyun')['Template']);
